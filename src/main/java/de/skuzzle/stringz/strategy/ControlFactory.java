...
/**
 * Factory interface for {@link java.util.ResourceBundle.Control Control}
 * instances. Implementations of this interface are required to have a no
 * arguments default constructor if they are to be used with the {@link Stringz}
 * class.
 *
 * <p>
 * On a class marked with {@link ResourceMapping} you can additionally specify
 * the {@link ControlFactory} to use for retrieving the
 * {@link java.util.ResourceBundle ResourceBundle} of that class using the
 * {@link ResourceControl} annotation. The {@link Stringz} class will then try
 * to instantiate the provided ControlFactory class and call its
 * {@link #create(ResourceMapping, String[])} method in order to create a
 * Control instance. That instance is passed to the ResourceBundle's
 * {@link java.util.ResourceBundle#getBundle(String, java.util.Locale, ClassLoader, Control)
 * getBundle} method.
 * </p>
 *
 * <p>
