...
public class DefaultFieldMapper implements FieldMapper {
     ...
     * 
     * <p>
     * Implements the default field assignment strategy for <tt>Stringz</tt>. If
     * the passed field is annotated with {@link ResourceKey}, the annotation's
     * value is used as key to reference the resource value. Otherwise, the
     * field's name will be used as key. The value for the field will be
